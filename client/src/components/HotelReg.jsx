...
//                 Phone
//             </label>
//             <input input='contact' type="text" placeholder="Type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required></input>
//             </div>
...
//                 Address
//             </label>
//             <input input='address' type="text" placeholder="Type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required></input>
//             </div>
...
const cities = ['Select City', 'Dubai', 'Singapore', 'New York', 'London']; // ✅ Dummy data
